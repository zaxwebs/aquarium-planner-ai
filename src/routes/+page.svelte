...
<section
	class="relative py-24 px-4 sm:px-6 lg:px-8 bg-black text-white flex flex-col justify-center lg:min-h-[450px]"
>
	<div class="absolute inset-0 bg-[url('images/bg-tank.png')] bg-cover bg-center z-0"></div>
	<div class="max-w-2xl mx-auto z-10">
		<h1 class="text-5xl text-center font-serif italic mb-8">Aquarium Planner AI</h1>
						...
						>
							...
							<Select.Content>
								{#each fishSizes as fishSize}
									<Select.Item value={fishSize.value}
										>{fishSize.label}</Select.Item
									>
								{/each}
							</Select.Content>
			...
			<fieldset class="border border-gray-200 p-4 rounded-md mb-6 bg-white md:p-6">
				...
				<div class="grid md:grid-cols-2 gap-4">
						...
						>
							...
							<Select.Content>
								{#each waterTypes as waterType}
									<Select.Item value={waterType.value}
										>{waterType.label}</Select.Item
									>
								{/each}
							</Select.Content>
					...
					<div>
						<label
							for="water-source"
							class="block text-sm font-medium text-gray-700 mb-2">Water Source</label
						>
						<Select.Root
					...
					<div>
						<label
							for="water-hardness"
							class="block text-sm font-medium text-gray-700 mb-2">Hardness</label
						>
						<Select.Root
